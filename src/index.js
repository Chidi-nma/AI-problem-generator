...
function generateProblem(event) {
  ...
  let prompt = `Generate ideas for solving real-life pressing and important problems related to ${instructionsInput.value} and step-by-step instructions on how to approach, solve the problem and start a profitable business, talk about the business model. Make the steps more practical and actionable for real life and add detail. I will give you a specific area or industry that I would like you to focus on, the problems and solution must be impacted by technology`;
